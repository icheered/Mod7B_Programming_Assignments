...
cl %cppfiles% /W3 /EHsc /std:c++latest /I include /I %SDL2dir%\include /Fo.\obj\ /link /SUBSYSTEM:CONSOLE %SDL2libdir%\SDL2.lib %SDL2libdir%\SDL2main.lib /out:contour.exe
